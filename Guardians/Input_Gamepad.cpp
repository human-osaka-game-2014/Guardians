...
const int CInputGamepad::XINPUT_KEY_LIST[] = {
...
const int CInputGamepad::XINPUT_KEY_MAX = sizeof(XINPUT_KEY_LIST) / sizeof(int);

const float CInputGamepad::INPUT_DEADZONE = ( 0.24f * FLOAT(0x7FFF) );
...
HRESULT CInputGamepad::UpdateControllerState()
{
    DWORD dwResult;
