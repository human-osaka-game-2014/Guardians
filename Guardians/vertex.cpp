...
const DWORD CVertex::D3DFVF_CUSTOMVERTEX = (D3DFVF_XYZRHW | D3DFVF_DIFFUSE | D3DFVF_TEX1);
...
void CVertex::DrawTextureLT(LPDIRECT3DDEVICE9 _pDevice, CTexture _texture, float _x, float _y, D3DCOLOR _color) {
	DrawTextureLT(_pDevice, _texture, _x, _y, 0.f, 0.f, _texture.GetWidth(), _texture.GetHeight(), _color);
}

void CVertex::DrawTextureCC(LPDIRECT3DDEVICE9 _pDevice, CTexture _texture, float _x, float _y, D3DCOLOR _color) {
	DrawTextureCC(_pDevice, _texture, _x, _y, 0.f, 0.f, _texture.GetWidth(), _texture.GetHeight(), _color);
}

void CVertex::DrawTextureLT(LPDIRECT3DDEVICE9 _pDevice, CTexture _texture, float _x, float _y, FRECT _rect, D3DCOLOR _color)
{
	DrawTextureLT(_pDevice, _texture, _x, _y, _rect.left, _rect.top, _rect.right, _rect.bottom, _color);
}
void CVertex::DrawTextureLT(LPDIRECT3DDEVICE9 _pDevice, CTexture _texture,D3DXVECTOR2 _vector2,FRECT _rect, D3DCOLOR _color )
{
	DrawTextureLT(_pDevice, _texture, _vector2.x, _vector2.y, _rect.left, _rect.top, _rect.right, _rect.bottom, _color);
}
void CVertex::DrawTextureCC(LPDIRECT3DDEVICE9 _pDevice, CTexture _texture, float _x, float _y, FRECT _rect, D3DCOLOR _color)
{
	DrawTextureCC(_pDevice, _texture, _x, _y, _rect.left, _rect.top, _rect.right, _rect.bottom, _color);
}

void CVertex::DrawTextureLT(LPDIRECT3DDEVICE9 _pDevice, CTexture _texture, float _x, float _y, float _srcL, float _srcT, float _srcR, float _srcB, D3DCOLOR _color) {
	// テクスチャ座標に変換
...
void CVertex::DrawTextureCC(LPDIRECT3DDEVICE9 _pDevice, CTexture _texture, float _x, float _y, float _srcL, float _srcT, float _srcR, float _srcB, D3DCOLOR _color) {
	// テクスチャ座標に変換
	float u1 = _srcL / _texture.GetWidth();
	float u2 = _srcR / _texture.GetWidth();
	float v1 = _srcT / _texture.GetHeight();
...
void CVertex::DrawTexture(LPDIRECT3DDEVICE9 _pDevice, float _x, float _y, D3DCOLOR _color) {
	// テクスチャ座標に変換
...
void CVertex::SetBillBoardMatrix( LPDIRECT3DDEVICE9 pd3dDevice, D3DXMATRIX* pMatMatrix )
{
...
D3DXMATRIX CVertex::GetBillBoardMatrix( LPDIRECT3DDEVICE9 pd3dDevice, D3DXMATRIX* pMatMatrix )
{
   D3DXMATRIX CameraMatrix, WorldMatrix, ScalingMatrix, TranslationMatrix;
...
void CVertex::GetScreenMatrix(D3DXMATRIX& out,float width,float height)
{
