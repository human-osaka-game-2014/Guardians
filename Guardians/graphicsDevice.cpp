...
-------------------------------------------------------------*/
BOOL CGraphicsDevice::Create3DDeviceObject(HWND _hWnd,bool isWindow)
{
	m_hMenu = NULL;
	m_hWnd = _hWnd;
...
HRESULT CGraphicsDevice::ChangeWindoeSize()
{
...
void CGraphicsDevice::ChangeDisplayMode()
{
...
/*-------------------------------------------------------------
	...
	@return　なし
-------------------------------------------------------------*/
void CGraphicsDevice::SetRender()
{
...
-------------------------------------------------------------*/
BOOL CGraphicsDevice::InitD3D(HWND _hWnd,bool _windowed) 
{
...
/*-------------------------------------------------------------
	...
	@return なし
-------------------------------------------------------------*/
void CGraphicsDevice::BeginScene(int _r, int _g, int _b)
{
	if( flag == false ){
...
-------------------------------------------------------------*/
HRESULT CGraphicsDevice::EndScene()
{
...
bool CGraphicsDevice::DeviceLost()
{
	// デバイスの現在の状態を取得
...
void CGraphicsDevice::ResetDevice()
{
	// リソースの解放
...
-------------------------------------------------------------*/
LPDIRECT3DDEVICE9 CGraphicsDevice::GetDevice()
{
	return m_pDevice;
}
...
-------------------------------------------------------------*/
void CGraphicsDevice::ReleaseGraphics()
{
	SAFE_RELEASE(m_pDevice);
	SAFE_RELEASE(m_pD3d);
}
D3DPRESENT_PARAMETERS CGraphicsDevice::GetParam()
{
	return m_d3dpp;
}

void CGraphicsDevice::SetActiveFlag(bool flg)
{
	m_isActive = flg;
}

void CGraphicsDevice::SetWindowRect(RECT rect)
{
	m_windowRect = rect;
}