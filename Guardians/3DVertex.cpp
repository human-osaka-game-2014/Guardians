...
void C3DVertex::DrawTexture(CTexture _texture, D3DXVECTOR3 _position) {
	DrawTexture(_texture, _position, 0, 0, _texture.GetWidth(), _texture.GetHeight());
}

void C3DVertex::DrawTexture(CTexture _texture, D3DXVECTOR3 _position, float _srcL, float _srcT, float _srcR, float _srcB) {
